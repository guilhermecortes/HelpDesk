...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar col-lg-4'></div>");
            ...
            this.del = $("<div class='ajax-file-upload-red exclui-img'><i class='fa fa-trash-o'></i>" + s.deletelStr + "</div>").appendTo(this.statusbar).hide();
