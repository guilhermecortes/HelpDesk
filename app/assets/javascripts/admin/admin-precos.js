$(function (){
    ...
    function addLinha(i)
    {
        ...
        str =  '<tr linha="'+i+'">'+
                    ...
                    '</td>'+
                    '<td>'+
                        '<input id="admin_categoria_promocao_'+i+'" class="checkbox" type="checkbox" value="true" name="admin_preco[promocao]">'+
                    '</td>'+
                    '<td class="center">'+
        ...
        if(validaForm())
        {
            ...
            $('#table-preco tbody tr').each(function(index, el) {
                ...
                obj_preco = {
                    ...
                    promocao: $(row).find('input[name="admin_preco[promocao]"]').is(':checked') 
                };
    ...
    function enviaPrecos(obj_params)
    {
        $.ajax({
            url: '/admin/precos/enviaPrecos',
            type: 'POST',
            data: {admin_preco: JSON.stringify(obj_params), acao: $('input[name=action_name]').val()},
        ...
        .done(function(data) {
            if(data.erro_produto_igual){
                ...
                window.location.href = "/admin/precos?estado=Inserido-sucesso"
            }
            else if(data.erro){
